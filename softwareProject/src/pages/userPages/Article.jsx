...
export default function Article() {
    return (
        <div className="bg-[var(--bg-footer)] min-h-screen p-6 md:p-12">
            {/* Header */}
            ...
            <div className="">
                ...
                <div className="flex flex-col md:flex-row-reverse items-center justify-center gap-8 md:gap-16  py-10 px-5">
                    ...
                    <p className="text-black leading-relaxed text-base md:text-xl max-w-xl line-clamp-3 md:line-clamp-none">
                        ...
                        patience, and the intimate connection between the artisan and her craft. Such embroidery not only decorates fabrics but also preserves cultural expression, passed down through
                        generations.
                    </p>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16  py-10 px-5">
                    ...
                    />
                    <p className="text-black leading-relaxed text-base md:text-xl max-w-xl  line-clamp-3 md:line-clamp-none">
                        This stunning embroidery tray showcases vibrant patterns rooted in Middle Eastern heritage. The careful arrangement of motifs and colors tells stories of community, resilience,
                        and artistry. Handmade embroidery like this is more than decoration—it is a form of cultural memory, carrying the spirit of ancestors into today’s homes and daily traditions.
                    </p>
                </div>
                ...
                <div className="flex flex-col md:flex-row-reverse items-center justify-center gap-8 md:gap-16 py-10 px-5">
                    ...
                    />
                    <p className="text-black leading-relaxed text-base md:text-xl max-w-xl line-clamp-3 md:line-clamp-none">
                        This stunning piece blends two powerful symbols of Palestinian heritage: The iconic black-and-white keffiyeh — a symbol of identity and resistance. Colorful tatreez embroidery
                        — a timeless tradition of storytelling through stitches. Together, they tell a story of resilience, roots, and pride. A heritage that lives on, thread by thread.
                    </p>
                </div>
            </div>
        </div>
