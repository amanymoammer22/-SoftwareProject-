  ...
  return (
      <>
          ...
          <div
              ...
              <div className="mt-10">
                  <DropdownCollection />
                  <FilterContent minPrice={minPrice} maxPrice={maxPrice} setMin={setMin} setMax={setMax} fetchProducts={fetchProducts} />
              </div>
          </div>
...
function FilterContent({
  ...
  return (
      <>
          ...
          <button
              onClick={() => fetchProducts(1, minPrice, maxPrice)}
                        ...
                        categories.map((cat) => (
                            <li key={cat._id}>
                                <Link
                                    ...
                                    className="block py-2 hover:bg-[var(--bg-colorA)] hover:text-[var(--bg-Color)] "
